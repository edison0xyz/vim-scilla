...
syn keyword scillaConstant      substr dist sha256hash put get remove contains[] blt badd bsub
...
" Transition syntax
syn match scillaProcedure /\<procedure\>/ nextgroup=procedureName skipwhite
syn match procedureName contained /\<[a-zA-Z_$][0-9a-zA-Z_$]*/ skipwhite

hi def link scillaTransition Type
hi def link transitionName Function

hi def link scillaProcedure Type
hi def link procedureName Function
